...
class TmodelCode extends CCodeModel
{
    ...
    public function prepare()
    {
        ...
        foreach($tables as $table)
        {
            ...
            $mainFile = Yii::getPathOfAlias($this->modelPath).'/'.$className.'.php';
            ...
            $searchFile = Yii::getPathOfAlias($this->modelPath).'/search/Search'.$className.'.php';
    ...
    public function generateRules($table)
    {
        ...
        foreach($table->columns as $column)
        {
            if($column->autoIncrement)
                continue;
            if (in_array($column->name,array('changed'))) {
                continue;
            }

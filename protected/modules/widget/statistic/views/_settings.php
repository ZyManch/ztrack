...
?>
<?php $module->renderPartial('field._graph',array(
    'system_module' => $system_module,
    'statistic' => $statistic,
    'config' => $config,
));?>

<?php $module->renderPartial('field._statistic',array(
    'system_module' => $system_module,
    'statistic' => $statistic,
    'config' => $config,
));?>
...
<?php foreach (Yii::app()->user->getUser()->getAvailableStatistics() as $statistic):?>
    ...
    <div class="statistic" id="statistic-<?php echo $statistic->id;?>"<?php if (!$isSelected):?> style="display:none"<?php endif;?>>
        ...
        <?php $module->renderPartial('field._axisX',array(
            'system_module' => $system_module,
            'statistic' => $statistic,
        ...
        <div class="axis-y-list">
            <?php foreach ($axisYList as $index => $axisY):?>
                ...
                <?php $module->renderPartial('field._axisY',array(
                    'system_module' => $system_module,
                    'statistic' => $statistic,
        ...
        <div class="filter">
            <div class="filter-list">
                <?php foreach ($filterList as $index => $filter):?>
                    ...
                    <?php $module->renderPartial('field._filter',array(
                        'system_module' => $system_module,
                        'statistic' => $statistic,
                        'value' => $filter['value'],

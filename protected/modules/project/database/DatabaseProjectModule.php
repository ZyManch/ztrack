...
class DatabaseProjectModule extends AbstractProjectModule {
    ...
    public function actionColumnUpdate() {
        ...
        $this->renderPartial('_columnUpdate',array(
            'project' => $project,
            'projectDatabase' => $projectDatabase,
            'column' => $column
        ));
    ...
    public function actionColumnCreate() {
        ...
        $this->renderPartial('_columnCreate',array(
            'project' => $project,
            'projectDatabase' => $projectDatabase,
            'count' => $count
        ));
    ...
    public function actionTableCreate() {
        ...
        $this->renderPartial('_tableCreate',array(
            'project' => $project,
            'projectDatabase' => $projectDatabase,
            'count' => $count
        ));
    ...
    public function actionInsert() {
        ...
        $this->renderPartial('_insert',array(
            'project' => $project,
            'projectDatabase' => $projectDatabase,
            'row' => $row
        ));
    ...
    public function actionManage() {
        $project = $this->_getProject();
        $this->renderPartial('_manage',array(
            'project' => $project
        ));
    }

...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="form-group">
        ...
        <div class="col-sm-4">
            ...
            <?php echo $form->error($model,'parent_page_id',array('class'=>'alert alert-danger alert-mini')); ?>
        </div>
	...
	<div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <?php echo $form->error($model,'body',array('class'=>'alert alert-danger alert-mini')); ?>
        </div>
	...
	<div class="form-group">
        ...
        <div class="col-sm-10">
            ...
            <?php echo $form->error($model,'progress',array('class'=>'alert alert-danger alert-mini')); ?>
        </div>
